prompt PL/SQL Developer Export Tables for user AVISHACO@LABDBWIN
prompt Created by avishaco on ιεν ωπι 15 ιεμι 2024
set feedback off
set define off
...
(
  ...
  gender        VARCHAR2(9) default 'Specified' not null,
...
insert into PARTICIPANT (participantid, pname, age, gender, address, pemail, sampleid)
values (10001, 'John Doe', 30, 'Specified', '123 Main St', 'john@example.com', 2);
commit;
prompt 241 records loaded
...
insert into STUDY (studyid, sdescription, startdate, enddate, title, publication, cnclousions)
values (5, ' A study on the genetic basis of resistance to antibiotics in bacteria.', to_date('01-11-2020', 'dd-mm-yyyy'), to_date('31-12-2024', 'dd-mm-yyyy'), ' Antibiotic Resistance Genetics', ' Microbiology Today', ' Identified key genetic mutations.');
insert into STUDY (studyid, sdescription, startdate, enddate, title, publication, cnclousions)
...
insert into STUDY (studyid, sdescription, startdate, enddate, title, publication, cnclousions)
values (10001, 'Study Description', to_date('23-06-2023', 'dd-mm-yyyy'), to_date('22-06-2023', 'dd-mm-yyyy'), 'Study Title', 'Publication', 'Conclusions');
insert into STUDY (studyid, sdescription, startdate, enddate, title, publication, cnclousions)
values (2098, 'Another Study Description', to_date('30-06-2023', 'dd-mm-yyyy'), to_date('01-06-2023', 'dd-mm-yyyy'), 'Another Study Title', 'Another Publication', 'More Conclusions');
commit;
...
values (343, 'TziMagnuson', 'tzi.magnuson@hondamo', 42107337, 3, 'Data Science', 13, 'Doctor', 14);
insert into RRESEARCHER (researcherid, rname, email, phone, department, researchfield, yearsofexperience, rdegree, numarticales)
values (344, 'EddieMcGinley', 'eddie.mcginley@topic', 76885910, 3, 'Molecular Biology', 13, 'Master', 14);
insert into RRESEARCHER (researcherid, rname, email, phone, department, researchfield, yearsofexperience, rdegree, numarticales)
values (345, 'MacBegley', 'm.begley@gna.com', 49756539, 3, 'Genomics', 6, 'Master', 11);
insert into RRESEARCHER (researcherid, rname, email, phone, department, researchfield, yearsofexperience, rdegree, numarticales)
values (346, 'TalRyan', 'talr@nat.uk', 38733387, 3, 'Machine Learning', 13, 'Assistant Profe', 17);
insert into RRESEARCHER (researcherid, rname, email, phone, department, researchfield, yearsofexperience, rdegree, numarticales)
values (347, 'ChetBello', 'chet.b@unicru.uk', 18867355, 3, 'Artificial Intellige', 10, 'Doctor', 9);
insert into RRESEARCHER (researcherid, rname, email, phone, department, researchfield, yearsofexperience, rdegree, numarticales)
...
insert into RRESEARCHER (researcherid, rname, email, phone, department, researchfield, yearsofexperience, rdegree, numarticales)
values (10002, 'Jane Doe', 'invalidemail.com', 1234567890, 1, 'Physics', 7, 'PhD', 15);
insert into RRESEARCHER (researcherid, rname, email, phone, department, researchfield, yearsofexperience, rdegree, numarticales)
values (10001, 'John Doe', 'johndoe@example.com', 1234567890, 1, 'Physics', 10, 'PhD', 5);
insert into RRESEARCHER (researcherid, rname, email, phone, department, researchfield, yearsofexperience, rdegree, numarticales)
...
insert into CONDUCTS (researcherid, studyid)
values (1, 7);
insert into CONDUCTS (researcherid, studyid)
values (1, 8);
insert into CONDUCTS (researcherid, studyid)
